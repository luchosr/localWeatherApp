      ...
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            (function() {
              //Modularized function that shows a determinate icon depending the day conditions.
            ...
            $(".boton").click(function() {
              //button trigger.
              if (cont % 2 === 0) {
                //condition to change from ºF to ºC the temperature measures.
                $(".temp").text(tempF + "ºF");
              } else {
                $(".temp").text(tempC + "ºC");
              }
